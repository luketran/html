										...
										<ul>
											<li>
												<label class="cuscheck" for="c1">
													<input type="checkbox" id="c1" name="" value=""><span>XS</span>
													
												</label>
											</li>
											<li>
												<label class="cuscheck" for="c2">
													<input type="checkbox" id="c2" name="" value=""><span>S</span>
													
												</label>
											</li>
											<li>
												<label class="cuscheck" for="c3">
													<input type="checkbox" id="c3" name="" value=""><span>M</span>
													
												</label>
											</li>
											<li>
												<label class="cuscheck" for="c4">
													<input type="checkbox" id="c4" name="" value=""><span>L</span>
													
												</label>
											</li>
											<li>
												<label class="cuscheck" for="c5">
													<input type="checkbox" id="c5" name="" value=""><span>XL</span>
                                    ...
                                    <div class="item-list">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                                <div class="item">
                                                    <div class="itemimg">
                                                        <a href="chi-tiet-sp.php"><img src="resources/images/content/itemimg2.png" alt=""></a>
                                                    </div>
