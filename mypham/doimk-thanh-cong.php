	...
	<section class="main">
		...
		<section class="wrapper">
			...
			<div class="forgotpass">
				<div class="stepcont">
					<div class="scanoun">
						<h5>Tài khoản của bạn đã được khôi phục</h5>
						<p>Bây giờ bạn có thể sử dụng thông tin bảo mật mới để đăng nhập vào tài khoản của mình. <br>
						Mật khẩu của bạn đã được thay đổi</p>
