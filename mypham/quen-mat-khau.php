			...
			<div class="forgotpass">
				<div class="stepcont">
					<div class="cconfirmtype">
						<h5>Chọn hình thức nhận mã đổi lại mật khẩu</h5>
						<form action="">
							<div class="form-check">
								<input class="form-check-input" type="radio" name="cconfirmtype" id="cfbyemail" value="" checked>
								<label class="form-check-label" for="cfbyemail">
									Nhận qua mail: <span>an@gmail.com</span>
								</label>
							</div>
							<div class="form-check">
								<input class="form-check-input" type="radio" name="cconfirmtype" id="cfbyphone" value="" checked>
								<label class="form-check-label" for="cfbyphone">
									Nhận qua tin nhắn: *****<span>3210	</span>
								</label>
							</div>
